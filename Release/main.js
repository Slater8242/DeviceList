...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"addDataToState\": () => (/* binding */ addDataToState),\n/* harmony export */   \"state\": () => (/* binding */ state),\n/* harmony export */   \"updateDataInState\": () => (/* binding */ updateDataInState)\n/* harmony export */ });\nconst state = {\n    data: []\n};\nconst addDataToState = (item) => {\n    state.data.push(item);\n};\nconst updateDataInState = (item) => {\n    state.data = state.data.map(el => {\n        if (el.uid === item.uid) {\n            return item;\n        }\n        return el;\n    });\n};\n\n\n//# sourceURL=webpack://webui/./src/state.ts?");
